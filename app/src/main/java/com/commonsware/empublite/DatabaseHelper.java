...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /*
        ...
        As such, when constructed it needs to be constructed with the Application context,
        not a context such as an Activity. This is so the rest of the application can use it and
        be sure that all components are accessing the same DatabaseHelper instance.
     */
    ...
    /*
        The constructor is private as DatabaseHelper is a Singleton.
        Only this class should be able to create a new instance of DatabaseHelper.
     */
